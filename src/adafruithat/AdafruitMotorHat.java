...
public class AdafruitMotorHat extends AdafruitHat {
	...
	public AdafruitMotorHat(int deviceAddr) throws UnsupportedBusNumberException {
		super(deviceAddr);
		setup();
	}
	
	public AdafruitMotorHat(int deviceAddr, int i2cBus) throws UnsupportedBusNumberException {
